CREATE TABLE IF NOT EXISTS accounts (
  ...
  UNIQUE INDEX UQ_accounts_number (number), 
...
CREATE TABLE IF NOT EXISTS customers (
  ...
  dni varchar(8) NULL, 
  UNIQUE INDEX UQ_customers_ruc (ruc), 
  UNIQUE INDEX UQ_customers_company_name (company_name), 
...
CREATE TABLE IF NOT EXISTS transactions (
  ...
  account_id_to bigint UNSIGNED NULL, 
...
CREATE TABLE convocatorias (
  ...
  insert into convocatorias 
	(convocatoriaName, created_by)
	values('Convocatoria 1', 1);
  insert into convocatorias 
	(convocatoriaName, created_by)
	values('Convocatoria 2', 1);
...
values(1,'Manuel','Ceballos','47345345')
...
CREATE TABLE detalle_convocatoria (
  ...
  INSERT INTO detalle_convocatoria
...
(1, 1, 1)
  ...
  CREATE TABLE tipoprocedimientos (
		id bigint NOT NULL AUTO_INCREMENT,
	  nombre varchar(75) NULL, 
		descripcion varchar(75) NULL, 
		state int not null default 1,
