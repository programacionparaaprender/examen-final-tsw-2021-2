...
BEGIN
    CREATE TABLE provinces (
	  ...
	  CONSTRAINT [FK_provinces_departments_department_id] FOREIGN KEY(department_id)
...
BEGIN
    CREATE TABLE users (
	  ...
	  CONSTRAINT [FK_users_districts] FOREIGN KEY(district_id)
...
BEGIN
    ...
    CREATE TABLE convocatorias (
	  ...
	  CONSTRAINT [FK_convocatorias_users_created] FOREIGN KEY(created_by)
		REFERENCES dbo.users (id),
	  CONSTRAINT [FK_convocatorias_users_updated] FOREIGN KEY(updated_by)
		REFERENCES dbo.users (id)
	) ;
END
...
INSERT INTO [banking-ddd-nest].dbo.customers
([type], created_at, created_by, company_name, ruc, first_name, last_name, dni)
values('C', getdate(),1,'','473453459','Luis','Correa','47345345')
...
BEGIN
    ...
    CREATE TABLE postulantes (
		...
		last_name varchar(75) NULL, 
		dni varchar(8) NULL, 
	  	created_at varchar(20) NOT NULL default getdate(),
	  	created_by bigint NOT NULL,
	  	updated_at varchar(20) NULL,
	  	updated_by bigint NULL,
	  	[state] int not null default 1,
	  	CONSTRAINT [PK_postulantes] PRIMARY KEY([id]),
	  	CONSTRAINT [FK_postulantes_users_created] FOREIGN KEY(created_by)
		REFERENCES dbo.users (id),
	  	CONSTRAINT [FK_postulantes_users_updated] FOREIGN KEY(updated_by)
		REFERENCES dbo.users (id)
	);
END
...
INSERT INTO dbo.postulantes
(created_by, first_name, last_name, dni)
values(2,'Manuel','Ceballos','47345345')
...
IF (not EXISTS (SELECT * 
                 FROM INFORMATION_SCHEMA.TABLES 
                 WHERE TABLE_SCHEMA = 'dbo' 
                 AND  TABLE_NAME = 'detalle_convocatoria'))
BEGIN
    ...
    CREATE TABLE detalle_convocatoria (
		...
		CONSTRAINT [FK_detalle_convocatoria_id_created] FOREIGN KEY(convocatoria_id)
		REFERENCES dbo.convocatorias(id),
		CONSTRAINT [FK_detalle_postulante_id_created] FOREIGN KEY(postulante_id)
		REFERENCES dbo.postulantes (id),
	  	CONSTRAINT [FK_detalle_convocatoria_users_created] FOREIGN KEY(created_by)
		REFERENCES dbo.users (id),
	  	CONSTRAINT [FK_detalle_convocatoria_users_updated] FOREIGN KEY(updated_by)
		REFERENCES dbo.users (id)
	) ;
END
...
INSERT INTO dbo.detalle_convocatoria
(convocatoria_id, postulante_id,created_by)
values
(2, 1, 2)
